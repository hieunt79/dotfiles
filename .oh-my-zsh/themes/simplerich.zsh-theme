...
precmd() { # cspell:disable-line
    ...
    update_command_status() {
        ...
        # Poker club royal flush
        #_SIMPLERICH_COMMAND_STATUS="${color}%(!.#.\U0001F0AA \U0001F0AB \U0001F0AD \U0001F0AE \U0001F0A1 \U0001F338 \U2649 ⌨  )%{$reset_color%}"
        # Barca colors: "blue red"
        _SIMPLERICH_COMMAND_STATUS="${color}%(!.#.\U0001F535 \U0001F534 ⌨  )%{$reset_color%}"
    }
